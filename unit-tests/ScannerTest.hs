...
main :: IO ()
main = do
  putStrLn "Scanner test"

  checkTokens [Token (AlexPn 0 1 1) (TInteger 123)] "123"

  checkTokens [Token (AlexPn 1 1 2) (TInteger 123)] " 123 "

  checkTokens
    [Token (AlexPn 1 1 2) (TInteger 123), Token (AlexPn 5 1 6) (TInteger 42)]
    " 123 42"

  checkTokens
      [ Token (AlexPn 0 1 1)    TLet
  ...
  checkTokens
    ...
    $ unlines ["if 42 21 { explicit ; block }", "else real", "     block 42"]

  checkTokens [Token (AlexPn 0 1 1) (TInteger 42)] "42 "

  {-
  checkTokens
    [ Token (AlexPn 0 1 1)   (TInteger 42)
